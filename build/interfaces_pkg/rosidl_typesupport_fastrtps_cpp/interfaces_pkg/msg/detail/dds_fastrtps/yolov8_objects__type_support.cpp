...
#include "interfaces_pkg/msg/detail/yolov8_objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::DetectedObject &,
...
cdr_serialize(
  const interfaces_pkg::msg::Yolov8Objects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::Yolov8Objects & ros_message)
{
  // Member: num_objects
  cdr >> ros_message.num_objects;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_pkg
max_serialized_size_Yolov8Objects(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::Yolov8Objects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::Yolov8Objects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::Yolov8Objects *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Yolov8Objects__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::Yolov8Objects *>(
...
static size_t _Yolov8Objects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Yolov8Objects(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Yolov8Objects__callbacks = {
  "interfaces_pkg::msg",
  "Yolov8Objects",
...
static rosidl_message_type_support_t _Yolov8Objects__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Yolov8Objects__callbacks,
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Yolov8Objects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, Yolov8Objects)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_Yolov8Objects__handle;
}
