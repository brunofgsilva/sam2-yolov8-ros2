...
#include "interfaces_pkg/msg/detail/list_of_tracking_masks__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const interfaces_pkg::msg::TrackingMask &,
  ...
  interfaces_pkg::msg::ListOfTrackingMasks & ros_message)
{
  // Member: list_of_masks
  {
    ...
    ros_message.list_of_masks.resize(size);
    for (size_t i = 0; i < size; i++) {
      interfaces_pkg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.list_of_masks[i]);
    }
  }
  ...
  // Member: list_of_masks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.list_of_masks[index], current_alignment);
    }
  }
  // Member: nr_of_objects_detected
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: list_of_masks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces_pkg::msg::typesupport_fastrtps_cpp::max_serialized_size_TrackingMask(
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::ListOfTrackingMasks;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::ListOfTrackingMasks *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::ListOfTrackingMasks *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ListOfTrackingMasks__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::ListOfTrackingMasks *>(
...
static size_t _ListOfTrackingMasks__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ListOfTrackingMasks(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ListOfTrackingMasks__callbacks = {
  "interfaces_pkg::msg",
  "ListOfTrackingMasks",
...
static rosidl_message_type_support_t _ListOfTrackingMasks__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ListOfTrackingMasks__callbacks,
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_ListOfTrackingMasks__handle;
}
