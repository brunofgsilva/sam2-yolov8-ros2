...
bool interfaces_pkg__msg__mask_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_pkg.msg._mask_detection.MaskDetection", full_classname_dest, 48) == 0);
  }
  interfaces_pkg__msg__MaskDetection * ros_message = _ros_message;
  {  // point
...
{
  /* NOTE(esteve): Call constructor of MaskDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_pkg.msg._mask_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MaskDetection");
