...
static const _ListOfTrackingMasks_type_support_symbol_names_t _ListOfTrackingMasks_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, ListOfTrackingMasks)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_pkg, msg, ListOfTrackingMasks)),
  }
};
...
{
  return &::interfaces_pkg::msg::rosidl_typesupport_cpp::ListOfTrackingMasks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_pkg, msg, ListOfTrackingMasks)() {
  return get_message_type_support_handle<interfaces_pkg::msg::ListOfTrackingMasks>();
}
